...
async def upgrade(db: BaseDBAsyncClient) -> str:
    return """
        ALTER TABLE "messages" ADD "timestamp" TIMESTAMPTZ NOT NULL;
        ALTER TABLE "messages" ADD "server_id" INT NOT NULL;
        ALTER TABLE "messages" ADD CONSTRAINT "fk_messages_server_32b57957" FOREIGN KEY ("server_id") REFERENCES "server" ("id") ON DELETE CASCADE;"""


async def downgrade(db: BaseDBAsyncClient) -> str:
    return """
        ALTER TABLE "messages" DROP CONSTRAINT IF EXISTS "fk_messages_server_32b57957";
        ALTER TABLE "messages" DROP COLUMN "timestamp";
        ALTER TABLE "messages" DROP COLUMN "server_id";"""
